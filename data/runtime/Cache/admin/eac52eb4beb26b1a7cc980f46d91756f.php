...
<div class="header">
    ...
    <div class="nav_sub">
       ...
       <a href="javascript:void(0);" id="J_flush_cache" hidefocus="true" data-uri="<?php echo U('cache/qclear');?>" title="更新缓存">清除缓存</a> | 
...
<div class="LeftMenu">
    <div class="menubox">
        <ul id="root_index" class="MenuList" data-uri="<?php echo U('index/left');?>"></ul>
        <div class="cl"></div>
    </div>
...
<div class="right_main">
	...
	<iframe width="100%" scrolling="yes" height="100%" frameborder="0" noresize="" src="<?php echo U('index/main');?>" name="MainIframe" id="MainIframe"></iframe>
</div>
